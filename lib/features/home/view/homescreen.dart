...
class HomeScreenView extends StatelessWidget {
  ...
  Widget _buildSectionTitle() {
    return  Text(
      ...
      style: AppFontStyle.text_20_600(AppColors.black, fontFamily: AppFontFamily.bold,
      ),
    );
  }
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                       Text(
                        'Become A Service\nProvider',
                        style: AppFontStyle.text_16_700(AppColors.white, fontFamily: AppFontFamily.bold,
                        ),
                      ),
                       hBox(6),
                      ...
                      _buildBulletPoint('Get Rated and tips \nfrom your customers'),
                       hBox(6),
                     CustomButton(onPressed: () => provider.onBecomeProviderTap(context),
                       text: 'Apply Now',
                       textStyle: AppFontStyle.text_12_600(AppColors.black, fontFamily: AppFontFamily.semiBold),
                       width: 120,
                       color: Colors.white,
                       )
                    ],
