...
class _VendorHomeScreenState extends State<VendorHomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (widget.openConversationId != null) {
        ...
        Future.microtask(() {
          Navigator.pushNamed(
            ...
            context.read<VendorHomeProvider>().locationSendToBackend(context);
          });
        });
      }
      ...
      homeProvider.locationSendToBackend(context);
          ...
          body: SafeArea(
            child: RefreshIndicator(
              onRefresh: () async {
                ...
                value.locationSendToBackend(context);
              },
        ...
        return Row(
          children: [
            CircleAvatar(
              ...
              backgroundImage:
                  (provider.homeModel.data?.profile?.image != null &&
              ...
              child:
                  ...
                  ? Text(
                      (provider.homeModel.data?.profile?.name?.isNotEmpty ??
                              false)
                          ? provider.homeModel.data!.profile!.name![0]
                                .toUpperCase()
                          : "",
